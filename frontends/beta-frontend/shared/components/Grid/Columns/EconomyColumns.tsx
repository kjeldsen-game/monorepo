...
export const economyColumns = () => {
    const columns: GridColDef[] = [
        ...
        },
        {
            ...
            renderCell: (params: GridCellParams) => (
                <Box
                    sx={{
                        paddingRight: '20px',
                        color: isNegative(params.row.thisWeekAmount)
                            ? '#C51A1A'
                            : 'black',
                    }}>
        ...
        // {
        //     field: 'lastWeek',
        //     renderHeader: () => <div>Last Week</div>,
        //     headerAlign: 'center' as GridAlignment,
        //     align: 'right' as GridAlignment,
        //     minWidth: 70,
        //     flex: 1,
        ...
        //             sx={{
        //                 paddingRight: '20px',
        //                 color: isNegative(params.row.lastWeekAmount)
        //                     ? '#C51A1A'
        //                     : 'black',
        //             }}>
        //             {params.row.lastWeekAmount.toLocaleString(undefined, {
        //                 minimumFractionDigits: 2,
        //                 maximumFractionDigits: 2,
        //             })}{' '}
        //             $
