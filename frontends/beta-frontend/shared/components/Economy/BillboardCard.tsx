...
import { alpha, Box, Button, Grid, TextField, Typography } from '@mui/material';
                    ...
                    {billboardDeal != undefined || billboardDeal != null ? (
                        ...
                        <Box
                            ...
                            <Typography fontSize={'14px'} color={'#54595E99'}>
                                You don't have selected Billboard Deal. To
                                select Deal, please click on the Button and
                                choose offer!
                            </Typography>
                        </Box>
                    )}
