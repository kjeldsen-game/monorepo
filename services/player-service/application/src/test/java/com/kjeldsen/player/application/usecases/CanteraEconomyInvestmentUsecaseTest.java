...
public class CanteraEconomyInvestmentUsecaseTest {
    ...
    private final CanteraEconomyInvestmentUsecase canteraEconomyInvestmentUsecase = new CanteraEconomyInvestmentUsecase(teamReadRepository, teamWriteRepository, canteraInvestmentEventWriteRepository);
    ...
    public void should_throw_exception_when_teamId_does_not_found() {
        ...
        RuntimeException exception = assertThrows(RuntimeException.class, () -> {
            canteraEconomyInvestmentUsecase.invest(Team.TeamId.of(teamId), points);
        });
    ...
    public void should_call_respositories_when_teamId_found() {
        ...
        canteraEconomyInvestmentUsecase.invest(teamId, points);
