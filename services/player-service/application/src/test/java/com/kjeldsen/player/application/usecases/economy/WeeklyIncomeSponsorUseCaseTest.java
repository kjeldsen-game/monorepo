...
@Component
public class WeeklyIncomeSponsorUseCaseTest {
    ...
    private final WeeklyIncomeSponsorUseCase weeklyIncomeSponsorUseCase = new WeeklyIncomeSponsorUseCase(teamReadRepository, incomeEventWriteRepository, teamWriteRepository);
    ...
    public void when_we_make_a_sponsors_income_generate_an_income_event() {
        ...
        weeklyIncomeSponsorUseCase.income(teamId, mode, wins);

        verify(incomeEventWriteRepository)
            .save(
                argThat(income -> income.getTeamId().equals(teamId)
                    && income.getIncomePeriodicity().equals(Team.Economy.IncomePeriodicity.WEEKLY)
    ...
    public void when_we_make_a_sponsors_income_with_conservative_right_amount() {
        ...
        Team.Economy.IncomeMode mode = Team.Economy.IncomeMode.CONSERVATIVE;
        Integer wins = 5;
        BigDecimal expectedAmount = BigDecimal.valueOf(100_000);
        ...
        Assertions.assertThat(weeklyIncomeSponsorUseCase.getAmount(mode, wins)).isEqualTo(expectedAmount);
    }
    ...
    public void when_we_make_a_sponsors_income_with_moderate_right_amount() {
        ...
        Integer wins = 5;
        BigDecimal expectedAmount = BigDecimal.valueOf(50_000).add(BigDecimal.valueOf(wins * 100_000));
    ...
    public void when_we_make_a_sponsors_income_with_an_aggressive_right_amount() {
        ...
        Integer wins = 5;
        BigDecimal expectedAmount = BigDecimal.valueOf(wins * 200_000);
