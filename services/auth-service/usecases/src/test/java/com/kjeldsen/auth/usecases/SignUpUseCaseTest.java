...
class SignUpUseCaseTest {
    ...
    private final AuthSignUpProducer mockAuthSignUpProducer = mock(AuthSignUpProducer.class);
    private final SignUpUseCase signUpUseCase = new SignUpUseCase(mockSignUpWriteRepository, mockSignUpReadRepository, mockAuthSignUpProducer);
    ...
    void should_sign_up_user_correctly() {
        ...
        verify(mockAuthSignUpProducer).send(signUp);
    }
    ...
    void should_throw_exception_if_username_already_exists() {
        ...
        verify(mockAuthSignUpProducer, times(0)).send(signUp);
    }
}