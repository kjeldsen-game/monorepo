...
class GetMatchUseCaseTest {
    ...
    void should_throw_error_when_match_not_found() {
        ...
        assertEquals("Match not found", assertThrows(RuntimeException.class, () -> {
    ...
    public void should_return_matches_based_on_leagueId() {
        ...
        assertThat(matches.isEmpty()).isEqualTo(false);
    ...
    public void should_return_matches_based_on_teamId() {
