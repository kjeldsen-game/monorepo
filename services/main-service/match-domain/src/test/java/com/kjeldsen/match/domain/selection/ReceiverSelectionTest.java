...
//import static com.kjeldsen.match.domain.selection.ReceiverSelection.selectFromForward;
//import static com.kjeldsen.match.domain.selection.ReceiverSelection.selectFromMidfield;
//
...
//
//        Team home = Team.builder().role(TeamRole.HOME).players(players).modifiers(TeamModifiers.builder().tactic().build().getTactic()).build();
